#!/usr/bin/env bash
# My OS X default/tweaks, updated for Yosemite. See hints.macworld.com and mths.be/osx for more!
...
# Don't ask if we're sure we want to open an application we just double clicked on... 
